...
voice_model.add(Conv2D(32, kernel_size=(3, 3), activation='relu', input_shape=input_shape))
...
voice_model.add(Dense(1024, activation='relu'))
...
ax1.set_title("MNIST voice model - batch 64")
...
ax2.set_ylabel("Loss")
ax2.set_title("MNIST voice model - batch 64")
